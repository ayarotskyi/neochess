...
use crate::domain::game::models::errors::InvalidPgnError;
...
mod tests {
    ...
    use crate::domain::game::models::{errors::InvalidPgnError, pgn::PgnValidator};
    ...
    fn test_create_pgn_success() {
        ...
        let expected = Ok(Pgn::new_unchecked(pgn_str.into()));

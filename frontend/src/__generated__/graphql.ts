...
export type GetMoveStatsQuery = { __typename?: 'Query', getMoveStats: Array<{ __typename?: 'GraphQLMoveStat', moveUci: string, avgOpponentElo: number, wins: number, total: number, draws: number }> };
